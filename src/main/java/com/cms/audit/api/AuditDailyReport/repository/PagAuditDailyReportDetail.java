...
@Repository
public interface PagAuditDailyReportDetail extends PagingAndSortingRepository<AuditDailyReportDetail, Long>, JpaSpecificationExecutor<AuditDailyReportDetail> {

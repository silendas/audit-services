...
public class CaseCategoryController {
    ...
    public ResponseEntity<Object> findAll(
        ...
        @RequestParam("case_code") Optional<String> caseCode,
        @RequestParam("name") Optional<String> name,
        @RequestParam("page") Optional<Integer> page,
        @RequestParam("size") Optional<Integer> size
    ){
        GlobalResponse response = caseCategoryService.findAll(caseId.orElse(null),name.orElse(null), page.orElse(0), size.orElse(10), caseCode.orElse(null)); 

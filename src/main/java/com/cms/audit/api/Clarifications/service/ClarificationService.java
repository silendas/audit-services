...
public class ClarificationService {
    ...
    public GlobalResponse edit(EditClarificationDTO dto, Long id) {
        try {
            ...
            CaseCategory setCaseCaegoryId = CaseCategory.builder().id(getClarification.get().getCaseCategory().getId()).build();
            ReportType setReportTypeId = ReportType.builder().id(getClarification.get().getReportType().getId())
                    .build();
    ...
    public GlobalResponse uploadFile(MultipartFile file, Long id) {
        try {
            ...
            User setUserId = User.builder().id(getClarification.get().getUser().getId()).build();
            Case setCaseId = Case.builder().id(getClarification.get().getCases().getId()).build();
            CaseCategory setCaseCaegoryId = CaseCategory.builder().id(getClarification.get().getCaseCategory().getId())
                    .build();
            ReportType setReportTypeId = ReportType.builder().id(getClarification.get().getReportType().getId())
                    .build();
            Clarification clarification = new Clarification(
